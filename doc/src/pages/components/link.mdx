...
<SamplePane>
  <a class="link" href="https://github.com" target="_blank">GitHub.com<svg class="icon"><use href={`${import.meta.env.BASE_URL}/open_in_new.svg`} /></svg></a>
</SamplePane>

```html
<a class="link" href="https://github.com" target="_blank">
  GitHub.com
  <svg class="icon"><use href={`${import.meta.env.BASE_URL}/open_in_new.svg`} /></svg>
</a>
```
