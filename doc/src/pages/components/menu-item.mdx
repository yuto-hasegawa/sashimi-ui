...
```html
<ul class="card" style="width: fit-content;">
  <li><a class="menu-item" href="#combination"><img class="icon" src="/sign_in.svg" />Sign in</a></li>
  <li><button class="menu-item"><img class="icon" src="/share.svg" />Share with friends</button></li>
</ul>
```
