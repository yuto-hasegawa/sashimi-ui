...
<SamplePane filled>
  <ul class="card" style="width: fit-content;">
    <li><a class="menu-item" href="#combination"><svg class="icon"><use href="/signin.svg" /></svg>Sign in</a></li>
    <li><button class="menu-item"><svg class="icon"><use href="/share.svg" /></svg>Share with friends</button></li>
  </ul>
</SamplePane>
